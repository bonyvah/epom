...
async def upload_project_documents(id: UUID, body: list[DocumentCreate], current_user: CurrentUser, db: DBSession):
    return await document_service.upload_documents_to_project(id, body, current_user, db)
